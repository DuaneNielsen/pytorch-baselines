...
from pytorch_baselines.common import explained_variance, zipsame, dataset, fmt_row, colorize, ActorCriticRLModel, \
    SetVerbosity, TensorboardWriter
from pytorch_baselines import logger
from pytorch_baselines.common.mpi_adam import MpiAdam
from pytorch_baselines.common.cg import conjugate_gradient
from pytorch_baselines.common.policies import ActorCriticPolicy
from pytorch_baselines.a2c.utils import find_trainable_variables, total_episode_reward_logger
from pytorch_baselines.trpo_mpi.utils import traj_segment_generator, add_vtarg_and_adv, flatten_lists
...
class TRPO(ActorCriticRLModel):
    ...
    def setup_model(self):
        ...
        from pytorch_baselines.gail.adversary import TransitionClassifier
