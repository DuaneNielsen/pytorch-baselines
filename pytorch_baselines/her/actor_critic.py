...
from pytorch_baselines.her.util import mlp
...
class ActorCritic:
    def __init__(self, inputs_tf, dim_obs, dim_goal, dim_action,
        ...
        :param o_stats (pytorch_baselines.her.Normalizer): normalizer for observations
        :param g_stats (pytorch_baselines.her.Normalizer): normalizer for goals
