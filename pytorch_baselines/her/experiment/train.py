...
from pytorch_baselines.common import set_global_seeds, tf_util
from pytorch_baselines.common.mpi_moments import mpi_moments
import pytorch_baselines.her.experiment.config as config
from pytorch_baselines.her.rollout import RolloutWorker
from pytorch_baselines.her.util import mpi_fork
...
def launch(env, logdir, n_epochs, num_cpu, seed, replay_strategy, policy_save_interval, clip_return,
    ...
    if num_cpu == 1:
        ...
        logger.warn(
            ...
            'https://github.com/openai/pytorch_baselines/issues/314 for further details.')
        logger.warn('****************')
        logger.warn()
