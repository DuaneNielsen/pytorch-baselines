...
from pytorch_baselines.her.util import import_function, flatten_grads, transitions_in_episode_batch
from pytorch_baselines.her.normalizer import Normalizer
from pytorch_baselines.her.replay_buffer import ReplayBuffer
...
class DDPG(object):
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        :param network_class: (str) the network class that should be used (e.g. 'pytorch_baselines.her.ActorCritic')
